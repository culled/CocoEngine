...
namespace Coco::Rendering
{
	...
	struct ShaderUniformDataSerializer
	{
		...
		static void Serialize(YAML::Emitter& emitter, const ShaderUniformData& data, const std::unordered_map<ShaderUniformData::UniformKey, Ref<Texture>>& textures);
		...
		static void Deserialize(const YAML::Node& baseNode,  ShaderUniformData& outData, std::unordered_map<ShaderUniformData::UniformKey, Ref<Texture>>& outTextures);
	};
}
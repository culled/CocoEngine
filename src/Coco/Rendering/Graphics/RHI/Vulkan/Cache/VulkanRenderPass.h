...
namespace Coco::Rendering::Vulkan
{
	...
	class VulkanRenderPass final : public CachedResource
	{
	private:
		GraphicsDeviceVulkan* _device;
		List<SubpassInfo> _subpassInfos;
		VkRenderPass _renderPass = nullptr;
		WeakRef<RenderPipeline> _pipelineRef;

	public:
		VulkanRenderPass(GraphicsDeviceVulkan* device, const Ref<RenderPipeline>& pipeline);
		~VulkanRenderPass() final;

		bool IsInvalid() const noexcept final { return _pipelineRef.expired(); }

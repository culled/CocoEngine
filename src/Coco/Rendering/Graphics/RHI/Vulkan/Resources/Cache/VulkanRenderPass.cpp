...
namespace Coco::Rendering::Vulkan
{
	...
	void VulkanRenderPass::CreateRenderPass()
	{
		...
		List<RenderPipelineAttachmentDescription> pipelineAttachments = _pipeline->GetPipelineAttachmentDescriptions();
		...
		List<Ref<RenderPipelineBinding>> renderPasses = _pipeline->GetPasses();

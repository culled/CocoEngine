...
#ifndef COCOENGINE_IMAGESAMPLERTYPES_H
#define COCOENGINE_IMAGESAMPLERTYPES_H
...
namespace Coco
{
	...
	struct ImageSamplerDescription
	{
		...
		ImageSamplerDescription() noexcept;
		ImageSamplerDescription(ImageFilterMode filterMode, ImageRepeatMode repeatMode, MipMapFilterMode mipMapFilterMode, uint32 maxAnisotropy) noexcept;
...
#endif //COCOENGINE_IMAGESAMPLERTYPES_H

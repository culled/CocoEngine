...
#ifndef COCOENGINE_KEYBOARDTYPES_H
#define COCOENGINE_KEYBOARDTYPES_H
...
namespace Coco
{
    ...
    enum class KeyboardModifierKeyFlags : uint8
    {
        None = 0,
        Control = 1 << 0,
        Shift = 1 << 1,
    ...
    EnumFlagOperators(KeyboardModifierKeyFlags)

    /// @brief Data for an event fired when a keyboard key is pressed/released
        ...
        public ButtonInputEvent
    {
        ...
        /// @brief Modifier keys pressed when this key event occurred
        KeyboardModifierKeyFlags ModifierKeys;
    ...
    /// @brief Data for an event fired when a keyboard character is entered
...
#endif //COCOENGINE_KEYBOARDTYPES_H
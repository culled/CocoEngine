...
namespace Coco
{
	...
	public:
		...
		void SetPerspectiveProjection(double fieldOfView, double aspectRatio, double nearClipDistance, double farClipDistance);
		...
		/// <param name="nearClipDistance">The near clip distance</param>
		/// <param name="farClipDistance">The far clip distance</param>
		void SetOrthographicProjection(double size, double aspectRatio, double nearClipDistance, double farClipDistance);

		/// <summary>
		/// Sets this camera to use a custom projection matrix
		/// </summary>
		/// <param name="projection">The custom projection matrix</param>
		void SetCustomProjection(const Matrix4x4& projection);
		...
		void SetViewMatrix(const Matrix4x4& view) { _viewMatrix = view; }
		Matrix4x4 GetViewMatrix() const { return _viewMatrix; }
